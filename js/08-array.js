...
// Array.from() // создаёт массив из массивоподобного или итерируемого объекта.
// Array.of(7) // создаёт массив с одним элементом 7
// Array(7) // создаёт пустой массив со значением свойства length равным 7 (7 empty слотов)