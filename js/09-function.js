...
// checkPermission(..) // Предикат - Проверяет доступ, возвращая true/false
// isEven(..)          // Предикат - Проверяет на чётность, возвращая true/false

// ! Короткая запись булевой функции !
