...
// * 7. let array = <array>.slice(start, end) // Копирует в него элементы с позиции <start> до <end> не вкл.

// Возвращает новый массив
// * 8. <array>.splice(ind, deleteCount, ...items) // Удаляет элементы и добавляет на их место новые
// Мутирует исходный массив
...
// ? Работает быстрее оператора spread
